...
const InteractionPanel: React.FC<InteractionPanelProps> = ({ onSubmit }) => {
  ...
  return (
    <div className="p-4 bg-greatek-bg-light/70 border-t border-greatek-border mt-auto shrink-0">
      {isLoading && (
      ...
      <div className="flex items-end w-full rounded-lg bg-white border border-gray-300 focus-within:ring-2 focus-within:ring-greatek-blue focus-within:border-transparent transition-shadow duration-200">
        <textarea
          ...
          className="flex-grow py-3 pl-5 pr-4 text-text-primary placeholder-text-secondary/70 focus:outline-none bg-transparent resize-none overflow-y-auto"
